...
function Productsphone() {
  ...
  return (
    ...
    <Link to={`/productsphone`}><img style={{ height:40}} className='border m-2' src='https://cdn-v2.didongviet.vn/files/categories/2023/1/24/0/1677214051673_icon_dm.png'/></Link>
