...
import { selectEarphone } from '../features/counter/counterSlice'
import {Link} from 'react-router-dom'
function Productsearphone() {
    const loaddata = useSelector(selectEarphone)
  return (
...
export default Productsearphone
